...
边车地址：`AISHOW_SGLANG_FL2VA_URL`（30010）、`AISHOW_SGLANG_REF2VA_URL`（30011）、`AISHOW_FASTH3_URL`（8000）、`AISHOW_H3_TURBO_URL`（30012）、`AISHOW_H3_PINKCHERRY_URL`（30013）、`AISHOW_H3_DIRECTOR_URL`（30014）、`AISHOW_LLADA_IMAGE_URL`（30020）。
